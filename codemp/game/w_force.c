						...
						&& trace_ent->client->ps.weapon == WP_SABER)
					{
							...
							&& !PM_InKnockDown(&trace_ent->client->ps))
						{
							...
							if (saber_lightning_blocked && !hand_lightning_blocked)
							{
								...
								{
								case SS_DUAL:
									NPC_SetAnim(trace_ent, SETANIM_TORSO, BOTH_P6_S6_T_, AFLAG_PACE);
									break;
								case SS_STAFF:
									NPC_SetAnim(trace_ent, SETANIM_TORSO, BOTH_P7_S7_T_, AFLAG_PACE);
									break;
								case SS_FAST:
								case SS_TAVION:
								case SS_STRONG:
								case SS_DESANN:
								case SS_MEDIUM:
									NPC_SetAnim(trace_ent, SETANIM_TORSO, BOTH_P1_S1_T_, AFLAG_PACE);
									break;
								case SS_NONE:
								default:
									NPC_SetAnim(trace_ent, SETANIM_TORSO, BOTH_P1_S1_T_, AFLAG_PACE);
...
qboolean Jedi_DisruptorDodgeEvasion(gentity_t* self, const gentity_t* shooter, trace_t* tr, int hitLoc)
{
	int dodgeAnim = -1;
