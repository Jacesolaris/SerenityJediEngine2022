...
constexpr auto FATIGUE_DODGE = 30;
constexpr auto FATIGUE_DODGEING = 25;
...
constexpr auto FLAG_QUICKPARRY = 10;
...
constexpr auto BLOCKPOINTS_AUTO = 3;
...
constexpr auto MAX_LEAVE_TIME = 2000;
constexpr auto MAX_RETURN_TIME = 1500;
