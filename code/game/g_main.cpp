...
void G_InitCvars(void)
{
	...
	g_remove_unused_weapons = gi.cvar("g_remove_unused_weapons", "1", CVAR_ARCHIVE);
	...
	g_IconBackgroundSlow = gi.cvar("g_iconbackgroundslow", "1", CVAR_ARCHIVE | CVAR_SAVEGAME | CVAR_NORESTART);
}
